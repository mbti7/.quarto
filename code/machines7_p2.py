...
class P2():
    ...
    def place_piece(self, selected_piece):
        ...
        head_set([P2.current_piece, placed_loc, selected_piece])
    ...
    def reset():
        P2.head = PlaceNode(None, new_board(), None, new_pieces(), False)
    ...
    for piece in available_pieces:
        ...
        for loc in able_locs:
            ...
            if score > worst_score:
                worst_score = score
        if worst_score < min_max_score:
            min_max_score = worst_score
            best_piece = piece
    return best_piece
